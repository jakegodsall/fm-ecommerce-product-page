...
function App() {
  ...
  return (
    <div className="flex h-screen w-screen flex-col font-main-font transition-all duration-300 md:px-10 lg:px-40">
      <Header
      ...
      />
      <div className="flex h-full flex-col items-center md:mt-10">
        <ProductItem
          data={DUMMY_DATA[0]}
          getSubmittedQuantity={handleFormSubmission}
        />
      </div>
    </div>
  );
